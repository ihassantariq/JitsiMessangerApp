...
namespace JitsiMeetSDK
{
    ...
    interface JitsiMeet
    {
        ...
        bool Application(UIApplication application, NSUserActivity userActivity, [NullAllowed] Action<IUIUserActivityRestoring> restorationHandler);
    ...
    interface JMCallKitProxy
    {
        ...
        void ReportOutgoingCallWith(NSUuid UUID, [NullAllowed] NSDate dateStartedConnecting);

        // +(void)reportOutgoingCallWith:(NSUUID * _Nonnull)UUID connectedAt:(NSDate * _Nullable)dateConnected;

        //[Static]
        //[Export("reportOutgoingCallWith:connectedAt:")]
...
namespace WebRTC
{
    ...
    partial interface Constants
    {
        // extern NSString *const _Nonnull kRTCVideoCodecVp8Name __attribute__((visibility("default")));
        [Field("kRTCVideoCodecVp8Name", "__Internal")]
        NSString kRTCVideoCodecVp8Name { get; }

        // extern NSString *const _Nonnull kRTCVideoCodecVp9Name __attribute__((visibility("default")));
        [Field("kRTCVideoCodecVp9Name", "__Internal")]
        NSString kRTCVideoCodecVp9Name { get; }

        // extern NSString *const _Nonnull kRTCVideoCodecH264Name __attribute__((visibility("default")));
        [Field("kRTCVideoCodecH264Name", "__Internal")]
        NSString kRTCVideoCodecH264Name { get; }

        // extern NSString *const _Nonnull kRTCLevel31ConstrainedHigh __attribute__((visibility("default")));
        [Field("kRTCLevel31ConstrainedHigh", "__Internal")]
        NSString kRTCLevel31ConstrainedHigh { get; }

        // extern NSString *const _Nonnull kRTCLevel31ConstrainedBaseline __attribute__((visibility("default")));
        [Field("kRTCLevel31ConstrainedBaseline", "__Internal")]
        NSString kRTCLevel31ConstrainedBaseline { get; }

        // extern NSString *const _Nonnull kRTCMaxSupportedH264ProfileLevelConstrainedHigh __attribute__((visibility("default")));
        ...
        // extern NSString *const _Nonnull kRTCMaxSupportedH264ProfileLevelConstrainedBaseline __attribute__((visibility("default")));
    ...
    interface RTCVideoEncoderSettings
    {
        ...
        // @property (assign, nonatomic) unsigned int targetBitrate;
        [Export("targetBitrate")]
        uint TargetBitrate { get; set; }
    ...
    interface RTCVideoEncoder
    {
        ...
        // @required -(RTCVideoEncoderQpThresholds * _Nonnull)scalingSettings;
        [Abstract]
        [Export("scalingSettings")]
    ...
    interface RTCVideoDecoder
    {
        ...
        // @required -(NSInteger)startDecodeWithSettings:(RTCVideoEncoderSettings * _Nonnull)settings numberOfCores:(int)numberOfCores __attribute__((deprecated("use startDecodeWithNumberOfCores: instead")));
        [Abstract]
        [Export("startDecodeWithSettings:numberOfCores:")]
        nint StartDecodeWithSettings(RTCVideoEncoderSettings settings, int numberOfCores);
        ...
        // @optional -(NSInteger)startDecodeWithNumberOfCores:(int)numberOfCores;
    ...
    [Protocol, Model]
    interface RTCEAGLVideoViewDelegate : RTCVideoViewDelegate
    {
    }
    ...
    partial interface Constants
    {
        ...
        // extern NSString *const kRTCFieldTrialAudioSendSideBweForVideoKey __attribute__((visibility("default")));
        [Field("kRTCFieldTrialAudioSendSideBweForVideoKey", "__Internal")]
        NSString kRTCFieldTrialAudioSendSideBweForVideoKey { get; }
        ...
        // extern NSString *const kRTCFieldTrialImprovedBitrateEstimateKey __attribute__((visibility("default")));
        [Field("kRTCFieldTrialImprovedBitrateEstimateKey", "__Internal")]
        NSString kRTCFieldTrialImprovedBitrateEstimateKey { get; }
        ...
        // extern NSString *const kRTCFieldTrialMedianSlopeFilterKey __attribute__((visibility("default")));
        [Field("kRTCFieldTrialMedianSlopeFilterKey", "__Internal")]
        NSString kRTCFieldTrialMedianSlopeFilterKey { get; }
    }

    partial interface Constants
    {
        // extern NSString *const kRTCFieldTrialTrendlineFilterKey __attribute__((visibility("default")));
        [Field("kRTCFieldTrialTrendlineFilterKey", "__Internal")]
        NSString kRTCFieldTrialTrendlineFilterKey { get; }
    }
    ...
    partial interface Constants
    {
        // extern NSString *const _Nonnull kRTCMediaConstraintsMinAspectRatio __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMinAspectRatio", "__Internal")]
        NSString kRTCMediaConstraintsMinAspectRatio { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMaxAspectRatio __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMaxAspectRatio", "__Internal")]
        NSString kRTCMediaConstraintsMaxAspectRatio { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMaxWidth __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMaxWidth", "__Internal")]
        NSString kRTCMediaConstraintsMaxWidth { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMinWidth __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMinWidth", "__Internal")]
        NSString kRTCMediaConstraintsMinWidth { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMaxHeight __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMaxHeight", "__Internal")]
        NSString kRTCMediaConstraintsMaxHeight { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMinHeight __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMinHeight", "__Internal")]
        NSString kRTCMediaConstraintsMinHeight { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMaxFrameRate __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMaxFrameRate", "__Internal")]
        NSString kRTCMediaConstraintsMaxFrameRate { get; }

        // extern NSString *const _Nonnull kRTCMediaConstraintsMinFrameRate __attribute__((visibility("default")));
        [Field("kRTCMediaConstraintsMinFrameRate", "__Internal")]
        NSString kRTCMediaConstraintsMinFrameRate { get; }
    ...
    interface RTCPeerConnectionDelegate
    {
        ...
        // @optional -(void)peerConnection:(RTCPeerConnection * _Nonnull)peerConnection didStartReceivingOnTransceiver:(sransceiver * _Nonnull)transceiver;
    ...
    interface RTCPeerConnectionFactoryOptions
    {
        ...
        // @property (assign, nonatomic) BOOL enableAes128Sha1_32CryptoCipher;
        [Export("enableAes128Sha1_32CryptoCipher")]
        bool EnableAes128Sha1_32CryptoCipher { get; set; }
    }
    ...
    interface RTCCallbackLogger
    {
        ...
        // -(void)start:(void (^ _Nullable)(NSString * _Nonnull))callback;
        [Export("start:")]
        void Start([NullAllowed] Action<NSString> callback);
